export default class Instruction {
	...
	constructor(name, var1, var2, rvar=var1){
		this.name = name;
		this.var1 = var1;
		this.var2 = var2;
		this.rvar = rvar;
	...
	static fromObject(obj){
		return new Instruction(obj.name, obj.var1, obj.var2, obj.rvar);
	}
	...
	execute(state){
		...
		switch(this.name){
			...
			case Instruction.names.equal[2]: state[this.rvar] = val1 === val2; break;
			...
			case Instruction.names.shiftRight[2]: state[this.rvar] = val1 >> val2; break;
			case Instruction.names.unsignedShiftRight[2]: state[this.rvar] = val1 >>> val2; break;
...
Instruction.names = {
	...
	equal: ["Equal", "eql", "eql"],
	lessThanOrEqualTo: ["Less Than or Equal To", "leq", "leq"],
